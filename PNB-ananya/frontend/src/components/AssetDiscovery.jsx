        ...
        >
          <div className="bg-[#1e293b]/95 backdrop-blur-sm border border-[#334155] rounded-lg shadow-2xl px-4 py-3 max-w-xs">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-bold text-sm text-textMain">{hoveredNode.type.label}</span>
            </div>
      ...
      {selectedNode && (
        <div className="glass-panel p-5 border-t-2 border-t-primary animate-pulse-once">
          <div className="flex items-center gap-3 mb-3">
            ...
            <button onClick={() => setSelectedNode(null)} className="ml-auto text-textMuted hover:text-textMain text-xs px-2 py-1 rounded border border-border hover:border-primary/50 transition-colors">✕ Close</button>
          </div>
